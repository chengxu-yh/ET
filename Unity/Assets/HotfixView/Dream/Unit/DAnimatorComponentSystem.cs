...
namespace ET
{
	public class DAnimatorComponentAwakeSystem : AwakeSystem<DAnimatorComponent>
	{
		public override void Awake(DAnimatorComponent self)
		{
			self.Awake();
		}
	}

	public class DAnimatorComponentUpdateSystem : UpdateSystem<DAnimatorComponent>
	{
		public override void Update(DAnimatorComponent self)
		{
			self.Update();
		}
	}
	
	public class DAnimatorComponentDestroySystem : DestroySystem<DAnimatorComponent>
	{
		public override void Destroy(DAnimatorComponent self)
		{
	...
	public static class DAnimatorComponentSystem
	{
